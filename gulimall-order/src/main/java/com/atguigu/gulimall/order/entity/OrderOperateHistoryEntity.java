...
public class OrderOperateHistoryEntity {
  ...
  public boolean equals(Object that) {
    ...
    OrderOperateHistoryEntity other = (OrderOperateHistoryEntity) that;
    return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
        && (this.getOrderId() == null ? other.getOrderId() == null
        : this.getOrderId().equals(other.getOrderId()))
        && (this.getOperateMan() == null ? other.getOperateMan() == null
        : this.getOperateMan().equals(other.getOperateMan()))
