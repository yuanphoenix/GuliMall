...
public class MqMessageEntity {
  ...
  public boolean equals(Object that) {
    ...
    return (this.getMessageId() == null ? other.getMessageId() == null
        ...
        && (this.getToExchane() == null ? other.getToExchane() == null
        : this.getToExchane().equals(other.getToExchane()))
        && (this.getRoutingKey() == null ? other.getRoutingKey() == null
        : this.getRoutingKey().equals(other.getRoutingKey()))
        && (this.getClassType() == null ? other.getClassType() == null
        : this.getClassType().equals(other.getClassType()))
        && (this.getMessageStatus() == null ? other.getMessageStatus() == null
        : this.getMessageStatus().equals(other.getMessageStatus()))
