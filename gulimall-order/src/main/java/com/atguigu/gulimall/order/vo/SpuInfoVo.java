...
public class SpuInfoVo {
  ...
  public boolean equals(Object that) {
    ...
    SpuInfoVo other = (SpuInfoVo) that;
    return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
        && (this.getSpuName() == null ? other.getSpuName() == null
        : this.getSpuName().equals(other.getSpuName()))
        && (this.getSpuDescription() == null ? other.getSpuDescription() == null
        : this.getSpuDescription().equals(other.getSpuDescription()))
        ...
        && (this.getPublishStatus() == null ? other.getPublishStatus() == null
        : this.getPublishStatus().equals(other.getPublishStatus()))
