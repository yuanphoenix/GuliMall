...
public class MemberReceiveAddressEntity {
  ...
  public boolean equals(Object that) {
    ...
    MemberReceiveAddressEntity other = (MemberReceiveAddressEntity) that;
    return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
        ...
        && (this.getDetailAddress() == null ? other.getDetailAddress() == null
        : this.getDetailAddress().equals(other.getDetailAddress()))
